/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --strict-vars=false` (hash: 88bdf4b62840532aa102733bdecb639d)
// Runtime types generated with workerd@1.20260526.1 2025-05-01 nodejs_compat
interface __BaseEnv_Env {
  ...
  FFMPEG_CONTAINER: DurableObjectNamespace<import("./index").FFmpegContainer>;
  VIDEO_WORKFLOW: Workflow<
    Parameters<import("./index").VideoProcessingWorkflow["run"]>[0]["payload"]
  >;
}
